...
def main():
    ...
    target = "D_Mora_total"  # crecimiento (diferencia log)
    ...
    out_png = os.path.join(OUT_DIR, "mora_change_branch_bootstrap95.png")
    plt.savefig(out_png, dpi=300)
    print("Gráfico guardado en:", out_png)

    # también guarda resumen numérico
    out_csv = os.path.join(OUT_DIR, "mora_change_bootstrap95_summary.csv")
